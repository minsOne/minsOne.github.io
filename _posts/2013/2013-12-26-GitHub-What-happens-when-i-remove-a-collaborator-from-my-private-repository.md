---
layout: post
title: "[번역]GitHub / Collaborating / 개인 저장소에서 협업자를 삭제했을 때 무슨 일이 일어나나요?"
description: ""
category: "translate"
tags: [git, GitHub]
---
...
프로젝트에서 협업자를 삭제했을 때, 공동 제작자들은 프로젝트의 접근 권한을 잃게되지만 프로젝트의 fork와 로컬 시스템에 복제된 프로젝트의 복사본에는 접근 권한이 유지됩니다.
